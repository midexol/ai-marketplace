...
export default function CreateAgentPage() {
  ...
  const inputClass =
    'w-full rounded-xl border border-[#2a2a2a] bg-[#1e1e1e] px-4 py-2.5 text-white placeholder-slate-500 transition focus:border-cyan-400/50 focus:outline-none focus:ring-2 focus:ring-cyan-400/20';
                ...
                <button
                  ...
                  className={`rounded-xl border px-4 py-3 font-medium capitalize transition ${
                    active
                      ...
                      : 'border-[#2a2a2a] bg-[#1e1e1e] text-slate-300 hover:border-[#3a3a3a]'
                  }`}
                >
                  {chain}
                </button>
